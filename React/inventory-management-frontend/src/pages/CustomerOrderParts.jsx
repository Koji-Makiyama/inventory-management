...
export default function CustomerOrderParts() {
    ...
    const url = 'http://localhost:8080/customer-order-parts';
    ...
    return(
        <>
            <GridContainer>
                <Grid col={10}>
                    <h1 className='text-centered'>All Customer Order Parts</h1>
                </Grid>
                <Grid col={10}>
                    <ModalToggleButton modalRef={modalRef1} opener>Add Customer Order Part</ModalToggleButton>
                    <ModalToggleButton modalRef={modalRef2} opener>Update Customer Order Part</ModalToggleButton>
